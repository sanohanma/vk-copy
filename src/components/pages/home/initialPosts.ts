...
export const initialPosts: IPost[] = [
  {
    ...
    images: [
      ...
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT76KPNm2i2RhHz4vRaCsfcFFZn-P58SQm76w&s',
    ],
  },
];
